...
pipeline {
    ...
    environment {
        author_name = "Hem Chandra"
        author_email = "sh@xyz.com"
        app_name = "boosting_ai_model"
        job_location = "Pipeline-as-code/DEEP-OC-org/DEEP-OC-boosting_ai_model/${env.BRANCH_NAME}"
    }
